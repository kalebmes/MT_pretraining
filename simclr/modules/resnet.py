# 3D ResNet encoder substituted for torchvision's pretrained 2D ResNet by Kaczmarek et al. (2025) https://github.com/emilykaczmarek/3D-Neuro-SimCLR/
# using MONAI's 3D ResNet implementation (Apache 2.0 License, see below)

def get_resnet(name, pretrained=False):
    resnets = {
        "resnet10": resnet10(spatial_dims=3, n_input_channels=1, num_classes=0, pretrained=pretrained),
        "resnet18": resnet18(spatial_dims=3, n_input_channels=1, num_classes=0, pretrained=pretrained),
        "resnet50": resnet50(spatial_dims=3, n_input_channels=1, num_classes=0, pretrained=pretrained),
    }
